...
defmodule Day24 do
  ...
  defp maybe_flip(pos, 1, n_black_neighbours, new_tiles) when n_black_neighbours == 0 or n_black_neighbours > 2 do
  ...
  def run_ab do
    instructions = read_data("day24_input.txt")


    to_flip = instructions
